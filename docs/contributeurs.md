...
Les contributions attendues : correction de libellés, reformulations en langage clair, amélioration de la méthode, traduction, retours d'usage documentés, outils de lecture des données ouvertes.
